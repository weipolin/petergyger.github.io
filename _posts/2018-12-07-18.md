...
Erstellt:		7. Dezember 2018  
Modifiziert:	14. Februar 2019  
...
Natürlich sind die Optionen nicht so umfangreich wie in Outlook. Nur stellt sich die Frage, wer dieses mehr an Optionen auch konsequent nutzt. Genauso wie MS Projekt, welches gegenüber einem MS Excel in Planung und Projekten in der Praxis kaum Anwendungschance hat....

### Aufgaben

![To-Do-Web](../images/mstodo/todo1.jpg)  

Der Menupunkt "Aufgaben" auf der linken Seite hat als Icon ein Haus. D.h. dieser Menupunkt ist die Basis. Anhand dreier Aufgaben die als Beispiel dienen, nachfolgend eine Übersicht was die Applikation für Möglichkeiten bietet. Die Aufgabenliste kann nach bestimmten Kriterien ("erledigt" / "Wichtigkeit" / "Fälligkeitsdatum" /etc.) sortiert werden. Das Menu dazu versteckt sich hinter den drei Punkten neben dem Titel "Aufgaben". Unabhängig davon hat es dort einen Schalter der definiert, ob die "Erledigter Aufgaben" angezeigt werden sollen.  

![To-Do-Web](../images/mstodo/todo1a.jpg)  

Danach kann ich nach Gutdünken Kriterien eine Aufgabe weiter nach oben setzen ("Drag and Drop") oder mit den Peilen über den Aufgaben nach oben / unten verschieben.  
...
Die englische Oberfläche ist selbsterklärend wie man nachfolgend sehen kann. Als erstes füge ich zur Aufgabe eine Teilaufgabe hinzu. Diesesmal mit der englissprachigen Version, um einen Eindruck zu vermitteln.  
...
Die einzelnen Dinge in der Einkaufsliste könnne über "Schritte hinzufügen" eingetragen werden.  
![To-Do-Web](../images/mstodo/sl6a.jpg)  
...
Ich bin der Insider Gruppe - [Microsoft To-Do Insider for Android](https://plus.google.com/communities/104352326256055408016) - schon länger beigetreten und hatte mit meinem Samsung S8 noch keinen Ärger. Insgesamt eine stabile Betaversion. Aktuell ist die Version 1.46.7625 / Insider Build #7625 installiert.  

Was die App seit der Version 1.45 der Windows App voraus hat, ist die Multiuser Möglichkeit. D.h. ich kann in der App mehrere Accounts führen. Praktisch, wenn man verschiedene Lebensbereich strikt trennen will bzw. stärker fokusieren will oder schlicht die Übersicht bewahren will. In Windows 10 muss man dieses Feature noch mit dem Browser "nachbauen". 
...
- [YouTube: Keep ProductiveWhat's New with Microsoft To-Do in 2019](https://www.youtube.com/watch?v=6IK8524zl5U)
...
- [Deskmodder.de: Microsoft To-Do nun offiziell mit Cortana Integration ](https://www.deskmodder.de/blog/2019/01/25/microsoft-to-do-nun-offiziell-mit-cortana-integration/)
