...
Der Aufbau entspricht einer XML Datei mit einem Element "discstub". Darin hat es ein Elemnent "Message", das einen beliebigen Text enthalten kann. Z.B. ein Hinweis wo der Datenträger ("DVD" / Blu Ray / VHS Tape / etc. ) abgelegt ist.
